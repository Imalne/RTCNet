...
# scan all the files that end with '_metric.py' under the metric folder
...
_metric_modules = [importlib.import_module(f'losses.{file_name}') for file_name in metric_filenames]